...
import com.jsy.community.api.IPropertyMarketLabelService;
...
public class PropertyMarketLabelServiceImpl extends ServiceImpl<PropertyMarketLabelMapper, ProprietorMarketLabelEntity> implements IPropertyMarketLabelService {
   @Autowired
