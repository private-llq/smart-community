...
//	}
     ...
     **/
    @Override
    public VisitorEntity selectCarNumberIsNoInvite(String carNumber, Long communityId, Integer status) {
        QueryWrapper<VisitorEntity> queryWrapper = new QueryWrapper<VisitorEntity>()
                ...
                .last("LIMIT 1");
        VisitorEntity visitorEntity = visitorMapper.selectOne(queryWrapper);
