...
public class UserHouseController {
	...
	public CommonResult<Page<UserHouseVo>> selectUserHouse(@RequestBody BaseQO<UserHouseEntity> baseQO,
	                                                       @ApiParam(value = "社区id")
	                                                       @RequestParam Long communityId) {
		Page<UserHouseVo> page = userHouseService.selectUserHouse(baseQO, communityId);
