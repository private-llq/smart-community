...
//
	...
	@ApiOperation("查询所有菜单")
	@GetMapping("/listMenu")
	public CommonResult listMenu(@RequestParam("id") Long communityId){
	...
	@PostMapping("/appMenu")
	public CommonResult appMenu(@RequestBody List<AppMenuEntity> appMenuEntityList){
		appMenuService.appMenu(appMenuEntityList);
		return CommonResult.ok();
	}
}
