...
public class RepairOrderController {
	 ...
	 * @Author lihao
	 * @Description 没有写查询条件  具体要等联调的时候再说
	 * @Date 2020/12/9 15:52
	 * @Param [communityId]
	 **/
	@ApiOperation("查询所有报修申请")
	@PostMapping("/listRepairOrder")
	public CommonResult<PageInfo<RepairOrderEntity>> listRepairOrder(@ApiParam("社区id") @RequestParam Long communityId,
	                                                                 @RequestBody BaseQO<RepairOrderEntity> baseQO) {
		PageInfo<RepairOrderEntity> pageInfo = repairOrderService.listRepairOrder(communityId, baseQO);
