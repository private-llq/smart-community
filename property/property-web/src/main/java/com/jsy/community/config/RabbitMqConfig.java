...
public class RabbitMqConfig {
    ...
    public static final String QUEUE_SMS_PURCHASE_DELAY = "queue_sms_purchase";
    public static final String EXCHANGE_SMS_PURCHASE_DELAY = "exchange_sms_purchase";
    ...
    /**
     * @Description: 短信购买配置延时队列
     * @author: DKS
     * @since: 2021/12/13 11:06
     * @Param: []
     * @return: org.springframework.amqp.core.Queue
     */
    @Bean(QUEUE_SMS_PURCHASE_DELAY)
    public Queue queueSmsPurchase() {
        return new Queue(QUEUE_SMS_PURCHASE_DELAY);
    }
    
    /**
     * @Description: 短信购买配置交换机延时
     * @author: DKS
     * @since: 2021/12/13 11:06
     * @Param: []
     * @return: org.springframework.amqp.core.Exchange
     */
    @Bean(EXCHANGE_SMS_PURCHASE_DELAY)
    public CustomExchange exchangeSmsPurchase() {
        Map<String, Object> args = new HashMap<>(1);
        args.put("x-delayed-type", "direct");
        return new CustomExchange(EXCHANGE_SMS_PURCHASE_DELAY, "x-delayed-message", true, false, args);
    }
    
    /**
     * @Description: 绑定交换机延时队列
     * @author: DKS
     * @since: 2021/12/13 11:06
     ...
     */
    @Bean
    public Binding bindingExchangeSmsPurchase(@Qualifier(QUEUE_SMS_PURCHASE_DELAY) Queue queue,
                                             @Qualifier(EXCHANGE_SMS_PURCHASE_DELAY) Exchange exchange) {
        return BindingBuilder.bind(queue).to(exchange).with("queue.sms.purchase").noargs();
    }
    //----------------------------------------------购买短信套餐-------------------------------------------------------
}
