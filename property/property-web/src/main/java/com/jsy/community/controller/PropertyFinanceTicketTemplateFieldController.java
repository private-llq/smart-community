...
public class PropertyFinanceTicketTemplateFieldController {
    ...
    @Permit("community:property:ticketTemplateField:addTicketTemplateField")
    ...
    @Permit("community:property:ticketTemplateField:updateTicketTemplateField")
    ...
    @Permit("community:property:ticketTemplateField:ticketTemplateFieldList")
