...
public interface HCNetSDK extends StdCallLibrary {
	...
	HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(System.getProperty("user.dir") + "\\facility\\facility-service\\src\\main\\java\\com\\jsy\\community\\sdk\\HCNetSDK.dll", HCNetSDK.class);
	/***************************宏定义***************************************/
	//常量
