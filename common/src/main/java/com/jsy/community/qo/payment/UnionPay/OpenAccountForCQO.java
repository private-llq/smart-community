...
public class OpenAccountForCQO implements Serializable {
    ...
    // 1：银行卡3要素
    // 2：运营商3要素
    @ApiModelProperty("认证类型-必填,0：姓名身份证2要素,1：银行卡3要素,2：运营商3要素")
    ...
    // 银行账号-条件必填
    // 使用银行卡3要素必填
    @ApiModelProperty("银行账号-条件必填,使用银行卡3要素必填")
    ...
    // 1-激活
    // 默认1-激活
    @ApiModelProperty("是否激活-必填,0-不激活,1-激活")
    ...
    // 用户联系电话-选填
    @ApiModelProperty("用户联系电话-选填")
    private String userTelNo;

    // 用户电子邮箱-选填
    @ApiModelProperty("用户电子邮箱-选填")
    @Pattern(regexp = RegexUtils.REGEX_EMAIL, message = "电子邮箱格式错误")
    private String userEmail;

    // 用户地址-选填
    @ApiModelProperty("用户地址-选填")
    private String userAddr;

    // 性别-选填
    // M：男
    // F：女
    @ApiModelProperty("性别-选填,M：男,F：女")
