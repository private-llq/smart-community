...
public class PropertyFinanceFormEntity implements Serializable {
	...
	@ApiModelProperty(value = "线上收费")
	private BigDecimal OnlineCharging;
	
	@ApiModelProperty(value = "线下收费")
	private BigDecimal OfflineCharging;
	
	@ApiModelProperty(value = "退款或者提现")
	private BigDecimal RefundOrWithdrawal;
