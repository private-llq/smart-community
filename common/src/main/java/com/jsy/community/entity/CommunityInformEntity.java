...
public class CommunityInformEntity extends BaseEntity {
    ...
    @NotBlank( groups = {addCommunityInformValidate.class, updateCommunityInformValidate.class}, message = "社区ID不能为空")
    private Long communityId;

    @ApiModelProperty(value = "社区通知消息状态，0紧急，1重要，2一般")
    @NotBlank( groups = {addCommunityInformValidate.class}, message = "社区状态未选择! 0紧急，1重要，2一般")
    ...
    @NotBlank( groups = {addCommunityInformValidate.class}, message = "请选择消息是否需要启用!")
