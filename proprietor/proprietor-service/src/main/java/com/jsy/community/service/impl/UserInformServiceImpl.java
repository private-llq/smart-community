...
public class UserInformServiceImpl extends ServiceImpl<UserInformMapper, UserInformEntity> implements IUserInformService {
    ...
    @Override
    public Map<String, Object> fildList(Long informId) {

        Map<String, Object> map = new HashMap<>();
        List<UserInformVO> list = userInformMapper.findList(informId);
        Long total = userInformMapper.findCount(informId);
        map.put("total",total);
        map.put("list",list);
        return map;
    }
