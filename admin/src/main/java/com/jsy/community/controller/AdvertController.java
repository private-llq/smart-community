...
public class AdvertController {
    ...
    public CommonResult update(@RequestBody AdvertEntity entity) {
        return CommonResult.ok(advertService.updateAdvert(entity));
    }
    ...
    public CommonResult delete(@RequestBody AdvertQO qo) {
        return CommonResult.ok(advertService.removeById(qo.getAdvertId()));
    }
    ...
    public CommonResult deleteList(@RequestBody AdvertIdList ids) {
        return CommonResult.ok(advertService.removeByIds(ids.getIds()));
    }
}
